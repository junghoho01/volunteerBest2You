...
class EmailForgotPassword {
    companion object {
        fun sendEmail(
            ...
            mimeMessage.subject = "Password Reset - Best2Help"
            ...
            val emailContent = """
                ...
                <body style="background-color: #00BBC4;                             
                    ...
                    <div class="container" style=" 
                        ...
                        <p style="color: #777;">Thank you for choosing our service. To sign-in, please use the following temporary password:</p>
                        <div class="verification-code">
                            <strong>$verificationCode</strong>
                        </div>
                        <p style="color: #777;">If you did not request this reset password, please ignore this email.</p>
